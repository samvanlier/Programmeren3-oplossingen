...
public class BlogControllerTest {
    ...
    public void testPostBlog() throws Exception {
        ...
        this.mvc.perform(
                post("/blog")
                        .param("subject", subject).param("message", message)
    ...
    @Test
    public void testGetBlogUserName() throws Exception {
        final Entry e1 = new Entry("hello", "world", "Sam");
        final Entry e2 = new Entry("hallo", "wereld", "Seb");
        ...
        this.mvc.perform(get("/blog").accept(MediaType.TEXT_HTML))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString(e1.getUser().getName())))
                .andExpect(content().string(containsString(e2.getUser().getName())));
    }
